...
public class RespondPong {
  public static final String _packageId = "d3a089ecbcc688bbd96ace45dc7d38a000e0423ec4c52d26c47957d9e5fded3d";

  public RespondPong() {
  }

  public static RespondPong fromValue(Value value$) throws IllegalArgumentException {
    ...
    return new pingpong.RespondPong();
  }
