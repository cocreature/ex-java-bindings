...
public final class Pong extends Template {
  public static final Identifier TEMPLATE_ID = new Identifier("d3a089ecbcc688bbd96ace45dc7d38a000e0423ec4c52d26c47957d9e5fded3d", "PingPong", "Pong");
  ...
  public CreateCommand create() {
    return new CreateCommand(Pong.TEMPLATE_ID, this.toValue());
  }

  public CreateAndExerciseCommand createAndExerciseArchive(Archive arg) {
    Value argValue = arg.toValue();
    return new CreateAndExerciseCommand(Pong.TEMPLATE_ID, this.toValue(), "Archive", argValue);
  }

  public CreateAndExerciseCommand createAndExerciseRespondPing(RespondPing arg) {
    Value argValue = arg.toValue();
    return new CreateAndExerciseCommand(Pong.TEMPLATE_ID, this.toValue(), "RespondPing", argValue);
  }

  public CreateAndExerciseCommand createAndExerciseRespondPing() {
  ...
  public static Pong fromValue(Value value$) throws IllegalArgumentException {
    ...
    return new pingpong.Pong(sender, receiver, count);
  }
  ...
  public String toString() {
    return String.format("pingpong.Pong(%s, %s, %s)", this.sender, this.receiver, this.count);
  }

  public static final class ContractId extends com.daml.ledger.javaapi.data.codegen.ContractId<Pong> {
    ...
    public ExerciseCommand exerciseArchive(Archive arg) {
      Value argValue = arg.toValue();
      return new ExerciseCommand(Pong.TEMPLATE_ID, this.contractId, "Archive", argValue);
    }

    public ExerciseCommand exerciseRespondPing(RespondPing arg) {
      Value argValue = arg.toValue();
      return new ExerciseCommand(Pong.TEMPLATE_ID, this.contractId, "RespondPing", argValue);
    }

    public ExerciseCommand exerciseRespondPing() {
  ...
  public static class Contract implements com.daml.ledger.javaapi.data.Contract {
    ...
    public Contract(ContractId id, Pong data, Optional<String> agreementText,
    ...
    public static Contract fromIdAndRecord(String contractId, Record record$,
      ...
      Pong data = Pong.fromValue(record$);
    ...
    @Override
    public String toString() {
      return String.format("pingpong.Pong.Contract(%s, %s, %s, %s, %s)", this.id, this.data, this.agreementText, this.signatories, this.observers);
    }
  }
}
