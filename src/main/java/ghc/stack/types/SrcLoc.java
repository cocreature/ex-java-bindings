...
public class SrcLoc {
  ...
  public String toString() {
    return String.format("ghc.stack.types.SrcLoc(%s, %s, %s, %s, %s, %s, %s)", this.srcLocPackage, this.srcLocModule, this.srcLocFile, this.srcLocStartLine, this.srcLocStartCol, this.srcLocEndLine, this.srcLocEndCol);
  }
}
