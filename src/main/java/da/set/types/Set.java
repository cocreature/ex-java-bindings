...
public class Set<k> {
  ...
  public DamlRecord toValue(Function<k, Value> toValuek) {
    ...
    fields.add(new DamlRecord.Field("map", this.map.entrySet().stream().collect(DamlCollectors.toDamlGenMap(v$0 -> toValuek.apply(v$0.getKey()), v$0 -> Unit.getInstance()))));
  ...
  public String toString() {
    return String.format("da.set.types.Set(%s)", this.map);
  }
}
